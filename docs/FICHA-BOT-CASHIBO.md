...
## 5. PREGUNTAS CLAVE PARA FILTRAR AL LEAD
1. ¿Lo busca para descanso familiar, para invertir, o para un negocio de hospedaje/bienestar?
2. ¿Ya conoce la zona de Cashibococha o la esta descubriendo?
3. ¿Que le importa mas: el precio, el entorno, la formalidad o el potencial de la zona?

## 6. PERFILES DE COMPRADOR
- RECREATIVO LOCAL (casa de campo): familia de Pucallpa que ya visita la zona -> "Tu casa de campo en la zona que tu familia ya disfruta".
- EMPRENDEDOR BIENESTAR/HOSPEDAJE: quiere ecolodge o retiro -> corredor con flujo internacional comprobado y sin grandes cadenas.
- INVERSIONISTA AMAZONICO: diversifica en suelo -> "Entra temprano en un corredor que viene creciendo" (sin prometer cifras).
- TURISTA DE RETIRO / SEGUNDA RESIDENCIA: busca calma y naturaleza -> "El corredor donde el mundo viene a reconectar".
