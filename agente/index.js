...
async function avisarAprobaciones() {
  // PANEL_URL en el .env solo si el panel cambia de direccion (sin barra final)
  const panel = (process.env.PANEL_URL || 'https://panel.urbisgroupinmobiliaria.com') + '/gastos'
...
async function tableroLeads(phone, datos, fallback) {
  ...
  const botones = [[{ t: '📊 Abrir el Kanban de leads', url: (process.env.PANEL_URL || 'https://panel.urbisgroupinmobiliaria.com') + '/leads' }]]
